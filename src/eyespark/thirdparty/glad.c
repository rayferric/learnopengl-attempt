/*
    ...
    OpenGL loader generated by glad 0.1.24a0 on Sat Jun 16 20:08:07 2018.
    ...
    if(max_loaded_major < 3) {
        ...
        for(index = 0; index < (unsigned)num_exts_i; index++) {
            ...
            if(local_str != NULL) {
                ...
                strcpy(local_str, gl_str_tmp); //fix [-Wstringop-overflow=] on GCC @ Why do you even need safe string copying when you've already allocated the exact length of gl_str_tmp
#endif
            }
